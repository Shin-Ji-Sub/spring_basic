...
public interface BoardMapper {
	...
	@Results(id = "boardResultMap",
			 value = {
					 ...
					 @Result(column = "boardNo", property = "attachments", many = @Many(resultMap = "boardAttachResultMap"))
			 })
	...
	@Results(id = "boardResultMap2",
			 value = {
					 ...
					 @Result(column = "writeDate", property = "writeDate"),
					 @Result(column = "modifyDate", property = "modifyDate"),
					 @Result(column = "boardNo", property = "attachments", many = @Many(select = "selectBoardAttachByBoardNo"))
			 })
