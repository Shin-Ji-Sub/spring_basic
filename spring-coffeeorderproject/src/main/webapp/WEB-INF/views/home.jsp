...
<html lang="ko">
    ...
    <head>
        ...
        <link href="/spring-coffeeorderproject/resources/userAssets/lib/lightbox/css/lightbox.min.css" rel="stylesheet">
        <link href="/spring-coffeeorderproject/resources/userAssets/lib/owlcarousel/assets/owl.carousel.min.css" rel="stylesheet">


        <!-- Customized Bootstrap Stylesheet -->
        <link href="/spring-coffeeorderproject/resources/userAssets/css/bootstrap.min.css" rel="stylesheet">

        <!-- Template Stylesheet -->
        <link href="/spring-coffeeorderproject/resources/userAssets/css/style.css" rel="stylesheet">
        <style>
        	.slide {
        		margin-top: 6rem;
        	}
                        ...
                        <div id="carouselId" class="carousel slide position-relative" data-bs-ride="carousel">
                            <div class="carousel-inner" role="listbox">
                                <div class="carousel-item active rounded">
                                    <img src="/spring-coffeeorderproject/resources/userAssets/img/hollys-brand-renewal-green.jpg" class="img-fluid w-100 h-100 bg-secondary rounded" alt="First slide">
                                 ...
                                 <c:if test="${ imageIsValid[product.prodNo] }">
	                               <div class="carousel-item rounded detail-product " data-productno="${product.prodNo}">
	                                    <img src="/spring-coffeeorderproject/resources/userAssets/img/product-menu-${ product.prodNo }.png" 
										        ...
										        <div  class="col-md-6 col-lg-4 col-xl-3 detail-product" data-productno="${products.prodNo}">
										            <div class="rounded position-relative fruite-item display-grid"data-productno="${products.prodNo}">
										                ...
										                <c:set var="imageName" value='${ imageIsValid[products.prodNo] ? "product-menu-" : "" }${ imageIsValid[products.prodNo] ? products.prodNo : "replacement" }' />
										                	<img src='/spring-coffeeorderproject/resources/userAssets/img/${ imageName }.png' class="img-fluid w-100 rounded-top" alt=""data-productno="${products.prodNo}">
                        ...
                        <div class="position-relative">
                            ...
                            <div class="d-flex align-items-center flex-nowrap">
                                <div class="bg-secondary rounded">
								   ...
								   <img src='/spring-coffeeorderproject/resources/userAssets/img/${ imageName }.png' class="img-fluid rounded" style="width: 100px; height: 100px;" alt=""data-productno="${board.prodNo}">
                                </div>
    ...
    <script src="/coffeeorderproject/assets/js/core/jquery-3.7.1.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0/dist/js/bootstrap.bundle.min.js"></script>
    <script src="/spring-coffeeorderproject/resources/userAssets/lib/easing/easing.min.js"></script>
    <script src="/spring-coffeeorderproject/resources/userAssets/lib/waypoints/waypoints.min.js"></script>
    <script src="/spring-coffeeorderproject/resources/userAssets/lib/lightbox/js/lightbox.min.js"></script>
    <script src="/spring-coffeeorderproject/resources/userAssets/lib/owlcarousel/owl.carousel.min.js"></script>

    <!-- Template Javascript -->
    <script src="/spring-coffeeorderproject/resources/userAssets/js/main.js"></script>
    <script>
    $(function() {	
    	...
    	<c:forEach var="product" items="${ productArr }" >
			$('.carousel-content-img[data-productno=${product.prodNo}]').attr('src', '/spring-coffeeorderproject/resources/userAssets/img/product-menu-${ product.prodNo }.png');
		</c:forEach>
		--%>
    	...
    	$('.search-detail').on('click', (e) => {
    		...
    		if (searchKeyword.length == 0) {
    			...
    			location.href = `/coffeeorderproject/hollysProduct/shop-search?search=\${ searchKeyword }&page=1&select=0`;	
        		}
		    ...
		    if (${loginUser == null}) {
		        ...
		        $.ajax({
		            "type" : "POST",
		            "url" : "/coffeeorderproject/hollysProduct/put-cart",
		            "data" : "productCount=" + productCount + "&prodno=" + prodno,
		            "dataType" : "text",
		            "success" : (result, status, xhr) => {
		                const ok = window.confirm("장바구니로 이동하시겠습니까?");
		                if (ok) {
		                    location.href = "/coffeeorderproject/hollysProduct/cart-product";
		                }else{
		                	location.reload();
		                }
		            },
	    ...
	    $('.detail-product, .detail-product > div img, .detail-product > div p, .detail-product > div h4 .detail-product > div > a:not(.put-cart-btn)').on('click', function(e) {
	    	...
	    	if($(e.target).data('productno') != null) {
	    		const prodno = $(this).data('productno');
		    	location.href = `/coffeeorderproject/hollysProduct/shop-detail?prodno=\${prodno}`;
	    	}
	    	e.stopPropagation();
	    	e.preventDefault();
	    });
