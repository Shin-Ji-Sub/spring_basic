...
<head>
	...
	<link href="/xml-coffeeorderproject/resources/userAssets/css/login.css" rel="stylesheet">
</head>
<body>
	<%-- Header Start --%>
    ...
    <script>
    	$(() => {
    		...
    		$('#my-register-btn').on("click", (e) => {
    			location.href = "/xml-coffeeorderproject/userAccount/register";
    		});
    		
    		// 사용자 인증 페이지로 이동
    		$('#my-resetPw-btn').on("click", (e) => {
    			location.href = "/xml-coffeeorderproject/userAccount/checkUser";
    		});
