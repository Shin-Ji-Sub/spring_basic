...
<head>
	...
	<link href="/xml-coffeeorderproject/resources/userAssets/css/register.css" rel="stylesheet">
...
<body>
    	...
    	<div class="container py-5">
		    <main>
			    <div class="main-container">
			      ...
			      <form:form action="/xml-coffeeorderproject/userAccount/register" method="POST" modelAttribute="user">
    ...
    <script src="/xml-coffeeorderproject/resources/userAssets/js/register.js"></script>
    <script>
	 	// Cancel Btn 기능 (home 화면으로 이동)
	    $('.register-cancel-btn').on('click', () => {
	    	location.href = "/xml-coffeeorderproject/userAccount/login";
	    });
    </script>
