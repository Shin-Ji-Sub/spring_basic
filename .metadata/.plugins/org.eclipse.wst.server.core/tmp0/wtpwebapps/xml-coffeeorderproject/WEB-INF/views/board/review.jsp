							...
							<td>
								<form action="search" method="POST">
									<input type="text" name="keyword"
										...
										placeholder="키워드 검색">
									<button type="submit"
										class="btn border-secondary rounded-pill px-2 py-1 text-primary">검색</button>
								</form>
								...
								<br>
								<a href="reviewboardwrite">글 작성하기</a>
						...
						<c:forEach var="board" items="${boardList}">
							<%-- <c:if test="${not board.boardDelete}">
								<tr>
									...
									<td><a
										href="detail?boardno=${board.boardNo}&pageNo=${pageNo}">
