...
<html lang="ko">
                        ...
                        <div id="carouselId" class="carousel slide position-relative" data-bs-ride="carousel">
                            <div class="carousel-inner" role="listbox">
                                <div class="carousel-item active rounded">
                                    <img src="/xml-coffeeorderproject/resources/userAssets/img/hollys-brand-renewal-green.jpg" class="img-fluid w-100 h-100 bg-secondary rounded" alt="First slide">
                                 ...
                                 <c:if test="${ imageIsValid[product.prodNo] }">
	                               <div class="carousel-item rounded detail-product " data-productno="${product.prodNo}">
	                                    <img src="/xml-coffeeorderproject/resources/userAssets/img/product-menu-${ product.prodNo }.png" 
										        ...
										        <div  class="col-md-6 col-lg-4 col-xl-3 detail-product" data-productno="${products.prodNo}">
										            <div class="rounded position-relative fruite-item display-grid"data-productno="${products.prodNo}">
										                ...
										                <c:set var="imageName" value='${ imageIsValid[products.prodNo] ? "product-menu-" : "" }${ imageIsValid[products.prodNo] ? products.prodNo : "replacement" }' />
										                	<img src='/xml-coffeeorderproject/resources/userAssets/img/${ imageName }.png' class="img-fluid w-100 rounded-top" alt=""data-productno="${products.prodNo}">
                        ...
                        <div class="position-relative">
                            ...
                            <div class="d-flex align-items-center flex-nowrap">
                                <div class="bg-secondary rounded">
								   ...
								   <img src='/xml-coffeeorderproject/resources/userAssets/img/${ imageName }.png' class="img-fluid rounded" style="width: 100px; height: 100px;" alt=""data-productno="${board.prodNo}">
                                </div>
    ...
    $(function() {	
    	...
    	<c:forEach var="product" items="${ productArr }" >
			$('.carousel-content-img[data-productno=${product.prodNo}]').attr('src', '/xml-coffeeorderproject/resources/userAssets/img/product-menu-${ product.prodNo }.png');
		</c:forEach>
		--%>
