...
//		try {
//			String path = "C:\\Users\\Administrator\\Shin2\\workspace\\java-web\\demoweb\\src\\main\\webapp\\WEB-INF\\config\\bean-config.properties";
...
//	}
	...
	AppSettingsDao dao;
	public AppSettingsService() {
		DemoWebBeanFactory2 factory = new DemoWebBeanFactory2();
		dao = factory.getSettingsDao();
	}
	
	public AppSettingDto findAppSettingBySettingName(String settingName) {
//		AppSettingsDao dao = new AppSettingsDao();
		AppSettingDto appSetting = dao.selectAppSetting(settingName);
		return appSetting;
	}
	
	public void modifyAppSetting(AppSettingDto appSetting) {
		dao.updateSettingName(appSetting);
	}
